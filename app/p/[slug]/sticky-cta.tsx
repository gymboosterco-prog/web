      ...
      <div className="max-w-md mx-auto flex gap-2">
        ...
        {waUrl && (
          <a
            ...
            className="flex items-center justify-center gap-1.5 px-4 py-3.5 rounded-xl font-bold text-sm border-2 transition-opacity hover:opacity-80 flex-shrink-0"
